...
orders <- orders#fread('../input/orders.csv')
products <- products#fread('../input/products.csv')
...
aisles <- aisles#fread('../input/aisles.csv')
departments <- departments#fread('../input/departments.csv')
